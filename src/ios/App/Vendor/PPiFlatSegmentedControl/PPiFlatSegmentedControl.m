    ...
    if (self) {
        ...
        for(NSDictionary *item in items){
            ...
            if([icon isKindOfClass:[UIImage class]]){
                ...
                button = [[UIAwesomeButton alloc] initWithFrame:CGRectMake(buttonWith*i, 0, buttonWith, frame.size.height) text:text icon:nil attributes:@{} andIconPosition:position];
            }
