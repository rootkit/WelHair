...
#define kGroupedTableViewCellTopRowImageCapInset				UIEdgeInsetsMake(3.0, 0.0, 1.0, 0.0)
...
- (void)layoutSubviews
{
	...
	if (_label.text != nil) {
		[_label setFrame:CGRectMake(self.contentView.frame.origin.x + kCellLabelMargin,
	...
	if (_descriptionLabel.text != nil) {
		[_descriptionLabel setFrame:CGRectMake(self.contentView.frame.origin.x + kCellLabelMargin,
											   self.contentView.origin.y,
											   kCellLabelWidth,
											   self.contentView.height)];
