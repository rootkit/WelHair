...
- (void)configureInputBarWithStyle:(JSMessageInputViewStyle)style
{
    CGFloat sendButtonWidth = (style == JSMessageInputViewStyleClassic) ? 64.0f : 64.0f;
    
    CGFloat width = self.frame.size.width - sendButtonWidth - 20;
...
- (void)configureSendButtonWithStyle:(JSMessageInputViewStyle)style
{
    ...
    if(style == JSMessageInputViewStyleClassic) {
        ...
        sendButton = [UIButton buttonWithType:UIButtonTypeCustom];
        sendButton.backgroundColor = [UIColor js_bubbleBlueColor];
        
        [sendButton setTitleColor:[UIColor js_bubbleLightGrayColor] forState:UIControlStateNormal];
        [sendButton setTitleColor:[UIColor whiteColor] forState:UIControlStateHighlighted];
