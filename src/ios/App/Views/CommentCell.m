...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.titleLbl = [[UILabel alloc] initWithFrame:CGRectMake(MaxX(self.imgView) + 10,
                                                                  Y(self.imgView) + 2,
                                                                  WIDTH(self) - MaxY(self.imgView) - 15 - kDateLblWidth,
                                                                  20)];
...
- (void)layoutSubviews
{
    ...
    self.imgView.frame = CGRectMake(15, 5, 50, 50);

    self.titleLbl.frame = CGRectMake(MaxX(self.imgView) + 10,
                                     Y(self.imgView) + 2,
                                     320 - MaxY(self.imgView) - 15 - kDateLblWidth,
                                     20);

    CGSize textSize = [Util textSizeForText:self.comm.description
                                   withFont:self.descriptionLbl.font
                              andLineHeight:20];
    self.descriptionLbl.frame = CGRectMake(MaxX(self.imgView) + 10,
                                           MaxY(self.titleLbl) + 4,
                                           220,
                                           textSize.height);
