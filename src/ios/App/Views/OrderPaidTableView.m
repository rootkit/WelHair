...
@interface OrderPaidTableView() <UITableViewDataSource, UITableViewDelegate>
...
@implementation OrderPaidTableView
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_PUSH_TO_PAIDORDER_PREVIEW_VIEW object:[self.datasource objectAtIndex:indexPath.row]];
}
...
- (void)getOrders
{
    ...
    [reqData setObject:[NSString stringWithFormat:@"%d", 1] forKey:@"status"];
